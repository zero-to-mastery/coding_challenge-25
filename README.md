...
## Emmanuel#9344- Hicotet-Event-App

This is App help users to create events of any time. The Features include

- Keep Track of participants of event attendees
- Edit, Delete, Create and Update Events
- Authentiocation
- File Upload
- Profile settings
  and Others
